...
setwd("C:/Users/gtonu/OneDrive/Documents/Gaga/Data Analysis/Google Certificate/Capstone/Data Extracted - Original")
getwd() 

#load original .csv files, a years worth of data from October 2021 to September 2022
...
ggplot(data=cyclistic_date) +
  geom_bar(mapping = aes(x=day_of_week, fill=member_casual))+
  scale_x_discrete(limits=c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"))+
    labs(title="Total Rides per Week", caption="Data collected by Gaga Tonukari")+
  facet_wrap(~member_casual)


#Total Riders per Bike Type
ggplot(data=cyclistic_date) +
  geom_bar(mapping = aes(x=rideable_type, fill=member_casual))+
  labs(title="Total Rides per Bike Type", caption="Data collected by Gaga Tonukari")


#Total Rides per Season
ggplot(data=cyclistic_date) +
  geom_bar(mapping = aes(x=season, fill=member_casual))+
  scale_x_discrete(limits=c("Summer", "Fall", "Winter", "Spring"))+
  labs(title="Total Rides per Season", caption="Data collected by Gaga Tonukari")+
  facet_wrap(~member_casual)
